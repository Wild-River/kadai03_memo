...
/* harmony export */ });
/* harmony import */ var apexcharts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
/* harmony import */ var _utils_mk_calc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
...
const chart01 = characterName => {
  ...
  const statLabels = ["スピード（舗装路）", "スピード（悪路）", "スピード（水上）", "加速度", "ミニターボの加速度", "重さ", "コイン増の加速度", "まがりやすさ（舗装路）", "まがりやすさ（悪路）", "まがりやすさ（水上）", "無敵の時のスピード"];
  const character = characters.find(c => c.name === characterName);
  const stats = (0,_utils_mk_calc__WEBPACK_IMPORTED_MODULE_1__.convertStatsHalf)(character); // chart-01

  // キャラクターごとのseries配列を生成
  const series = [{
    name: character.name_ja,
    data: [stats.on_road_speed, stats.off_road_speed, stats.water_speed, stats.acceleration, stats.mini_turbo, stats.weight, stats.coin_curve, stats.on_road_handling, stats.off_road_handling, stats.water_handling, stats.invincibility]
  }];
  ...
  if (chartSelector.length) {
    chartOneInstance = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(document.querySelector("#chartOne"), chartOneOptions);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   calcCombined: () => (/* binding */ calcCombined),
/* harmony export */   convert: () => (/* binding */ convert),
/* harmony export */   convertHalf: () => (/* binding */ convertHalf),
/* harmony export */   convertStatsHalf: () => (/* binding */ convertStatsHalf)
/* harmony export */ });
const convert = (value, base) => parseFloat((value / 5 + base).toFixed(1));
...
const calcCombined = (character, vehicle) => {
...
const chart02 = vehicleName => {
  ...
  const statLabels = ["スピード（舗装路）", "スピード（悪路）", "スピード（水上）", "加速度", "ミニターボの加速度", "重さ", "コイン増の加速度", "まがりやすさ（舗装路）", "まがりやすさ（悪路）", "まがりやすさ（水上）", "無敵の時のスピード"];
  const vehicle = vehicles.find(c => c.name === vehicleName);
  const stats = (0,_utils_mk_calc__WEBPACK_IMPORTED_MODULE_1__.convertStatsHalf)(vehicle); // chart-02
  ...
  if (chartSelector.length) {
    chartTwoInstance = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(document.querySelector("#chartTwo"), chartTwoOptions);
...
const chart03 = combined => {
  ...
  const series = [{
    ...
    data: [characterStats.on_road_speed, characterStats.off_road_speed, characterStats.water_speed, characterStats.acceleration, characterStats.mini_turbo, characterStats.weight, characterStats.coin_curve, characterStats.on_road_handling, characterStats.off_road_handling, characterStats.water_handling, characterStats.invincibility]
  }, {
    name: combined.vehicle.name_ja,
    data: [vehicleStats.on_road_speed, vehicleStats.off_road_speed, vehicleStats.water_speed, vehicleStats.acceleration, vehicleStats.mini_turbo, vehicleStats.weight, vehicleStats.coin_curve, vehicleStats.on_road_handling, vehicleStats.off_road_handling, vehicleStats.water_handling, vehicleStats.invincibility]
  }];
  ...
  if (chartSelector.length) {
    chartThreeInstance = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(document.querySelector("#chartThree"), chartThreeOptions);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   mkCharacters: () => (/* binding */ mkCharacters)
/* harmony export */ });
const mkCharacters = [{
  "name": "Mario",
  "name_ja": "マリオ",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   mkVehicles: () => (/* binding */ mkVehicles)
/* harmony export */ });
const mkVehicles = [{
  "name": "standard_kart",
  "name_ja": "スタンダードカート",
...
/* harmony import */ var _alpinejs_persist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _components_charts_chart_01__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _components_charts_chart_02__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
/* harmony import */ var _components_charts_chart_03__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
/* harmony import */ var _components_data_mk_characters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9);
/* harmony import */ var _components_data_mk_vehicles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(10);
/* harmony import */ var _components_utils_mk_calc__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6);
...
window.chart01 = _components_charts_chart_01__WEBPACK_IMPORTED_MODULE_3__["default"];
window.chart02 = _components_charts_chart_02__WEBPACK_IMPORTED_MODULE_4__["default"];
window.chart03 = _components_charts_chart_03__WEBPACK_IMPORTED_MODULE_5__["default"];
window.calcCombined = _components_utils_mk_calc__WEBPACK_IMPORTED_MODULE_8__.calcCombined;
window.convertStatsHalf = _components_utils_mk_calc__WEBPACK_IMPORTED_MODULE_8__.convertStatsHalf;
...
if (!localStorage.getItem('mk_characters')) {
  localStorage.setItem('mk_characters', JSON.stringify(_components_data_mk_characters__WEBPACK_IMPORTED_MODULE_6__.mkCharacters));
}
if (!localStorage.getItem('mk_vehicles')) {
  localStorage.setItem('mk_vehicles', JSON.stringify(_components_data_mk_vehicles__WEBPACK_IMPORTED_MODULE_7__.mkVehicles));
}
